...

{
    ...
    {
        DefaultCommand.Add("GDM-74303", new CheckedMeterCommand(){ToPortCmd = "IDN?", InPorToCmd = "Ok",Delay = 50});
        DefaultCommand.Add("ASS-743", new CheckedMeterCommand(){ToPortCmd = "Status?", InPorToCmd = "GWInst", Delay = 50});
        DefaultCommand.Add("DPO-3014", new CheckedMeterCommand(){ToPortCmd = "HEH?", InPorToCmd = "Ok", Delay = 50});
        //и тд
    }
